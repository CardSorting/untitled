...
<div class="relative group">
    ...
    <div class="relative">
        <div x-data="{ mainTab: 'animals', animalTab: 'pets', peopleTab: 'healthcare', sportsTab: 'team_sports' }">
            ...
            <!-- Category Panels -->
            @include('stickers.create-sections._animal_category_panel', ['countries' => $countries ?? []])
            @include('stickers.create-sections._people_category_panel', ['countries' => $countries ?? []])
            @include('stickers.create-sections._sports_category_panel', ['countries' => $countries ?? []])
        </div>
    </div>
