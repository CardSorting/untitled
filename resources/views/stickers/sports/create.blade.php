        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 py-12 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <p class="mt-3 text-lg text-blue-100 max-w-3xl">
                    Design your custom sports sticker with our AI-powered generator
                </p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl transform transition-all duration-300 hover:shadow-2xl border border-gray-100">
                <div class="p-8 space-y-8">
                    ...
                    <form action="{{ route('stickers.sports.store') }}" method="POST" class="space-y-8">
                        @csrf

                        <!-- Sports Categories -->
                        <div class="space-y-4">
                            <label class="block text-sm font-medium text-gray-700">Sports Category</label>
                        ...
                        <!-- Athlete Types -->
                        <div class="space-y-4">
                            <label class="block text-sm font-medium text-gray-700">Athlete Type</label>
                            <div class="grid grid-cols-2 gap-4">
                                @foreach($athleteTypes as $type)
                                    <div class="relative">
                                        <input type="radio" 
                                               name="athlete_type" 
                                               value="{{ $type }}"
